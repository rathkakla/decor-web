...
$tickets = [
    [
        "id"       => "TKT-202",
        "sender"   => "Modern Craft",
        "subject"  => "Kendala Pencairan Dana",
        "category" => "Finance",
        "status"   => "Open",
    ...
    [
        "id"       => "TKT-198",
        "sender"   => "Studio Archi",
        "subject"  => "Gagal Upload Produk Baru",
        "category" => "Technical",
        "status"   => "Diproses",
    ...
    [
        "id"       => "TKT-185",
        "sender"   => "WoodCraft Ltd",
        "subject"  => "Banding Akun Terkena Suspend",
        "category" => "Account",
        "status"   => "Selesai",
...
$stats = [
    ["label" => "Open",     "value" => "12", "icon" => "alert-circle",  "note" => "butuh respon",   "color" => "danger"],
    ["label" => "Diproses", "value" => "08", "icon" => "refresh-cw",    "note" => "sedang berjalan", "color" => "info"],
    ["label" => "Selesai",  "value" => "45", "icon" => "check-circle",  "note" => "minggu ini",      "color" => "success"],
    ["label" => "Avg. Response", "value" => "18m", "icon" => "clock",   "note" => "response time",   "color" => "primary"],
];
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-outline { display: flex; align-items: center; gap: 6px; padding: 9px 16px; border-radius: 10px; font-size: 11px; font-weight: 700; border: 1.5px solid var(--border); background: var(--surface); color: var(--text-soft); cursor: pointer; transition: 0.15s; text-decoration: none; }
        ...
        .btn-primary { display: flex; align-items: center; gap: 6px; padding: 9px 18px; border-radius: 10px; font-size: 11px; font-weight: 700; background: var(--primary); color: #fff; border: none; cursor: pointer; transition: 0.15s; text-decoration: none; }
        ...
        .bubble.seller { background: var(--surface); border: 1px solid var(--border-soft); color: var(--text); border-bottom-left-radius: 4px; }
...
<main>
    ...
    <div class="page-header">
        <div>
            ...
            <div class="page-title">Seller Support Center</div>
            <div class="page-desc">Tanggapi keluhan, banding akun, dan bantuan teknis dari para seller.</div>
        </div>
    ...
    <div class="toolbar">
        <div class="search-wrap">
            ...
            <input class="search-input" type="text" placeholder="Cari tiket, seller, atau subjek…">
        </div>
    ...
    <div class="ticket-list">
        ...
        <div class="ticket-row st-<?= $sl ?>">
            ...
            <div class="tcell">
                ...
                <span class="sender-cat <?= $cat_cls ?>">
                    <?= $t['category'] ?>
                </span>
            </div>

            <!-- Subject -->
            <div class="tcell" style="grid-column: span 1;">
            ...
            <!-- Status -->
            <div class="tcell">
                <select class="status-select status-<?= $sl ?>"
    ...
    <div class="chat-content">
        <div class="chat-header">
            <div class="chat-header-left">
                <div class="chat-header-icon"><i data-feather="headphones"></i></div>
                <div>
        ...
        <div class="chat-body" id="chatWindow">
            <div class="bubble-wrap">
                <div class="bubble-meta">Seller · Just now</div>
                <div class="bubble seller">Halo Admin, ada kendala pada akun saya. Mohon bantuannya segera.</div>
            </div>
