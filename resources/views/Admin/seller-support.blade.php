...
<main>
    <div class="page-header">
        <div>
            ...
            <div class="page-desc">Tanggapi keluhan dan bantuan teknis dari para seller.</div>
        </div>
    </div>
    ...
    <div class="ticket-list">
        ...
        <div class="ticket-row st-{{ $t->status }}">
            ...
            <div class="tcell"><div class="sender-name">{{ $t->user->full_name }}</div><span class="nav-label">Seller</span></div>
