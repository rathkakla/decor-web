...
if ($current_path == "" || $current_path == "index") {
    $current_path = "product-validation";
}
...
$pending_products = [
    [
        ...
        "description" => "Sofa minimalis dengan aksen kayu jati solid. Menggunakan busa high-density yang tidak mudah kempes dan kain pelapis velvet premium.",
        "material"    => "Teak Wood, Velvet Fabric",
    ...
    [
        ...
        "category"    => "Table",
        "price"       => "Rp 8.200.000",
        "image"       => "https://images.unsplash.com/photo-1530018607912-eff2df114fbe?w=600",
        "description" => "Meja makan elegan dari kayu Oak Amerika. Finishing menggunakan natural oil untuk menonjolkan serat kayu asli yang mewah.",
        "material"    => "Solid American Oak",
    ...
    [
        ...
        "description" => "Kursi lounge dengan anyaman rotan asli berkualitas tinggi. Rangka menggunakan besi powder-coated anti-karat untuk ketahanan jangka panjang.",
        "material"    => "Natural Rattan, Iron Frame",
...
$stats = [
    ["label" => "Pending",    "value" => "14", "icon" => "clock",        "note" => "menunggu review",  "color" => "warning"],
    ["label" => "Disetujui",  "value" => "38", "icon" => "check-circle", "note" => "minggu ini",       "color" => "success"],
    ["label" => "Ditolak",    "value" => "05", "icon" => "x-circle",     "note" => "perlu revisi",     "color" => "danger"],
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .product-row {
            ...
            display: grid; grid-template-columns: 72px 200px 1fr 110px 110px 90px 180px;
        ...
        .prod-price { font-size: 13px; font-weight: 800; color: var(--text); }
        ...
        .detail-price { font-size: 20px; font-weight: 800; color: var(--primary); margin-top: 6px; }
    ...
    <div class="product-list">
        ...
        <div class="product-row st-<?= $sl ?>" id="row-<?= $p['id'] ?>">
            ...
            <div class="tcell">
                ...
                <div class="prod-shop"><?= $p['shop'] ?></div>
            </div>
            ...
            <div class="tcell">
                <div class="action-cell">
                    <button class="btn-approve"
                        onclick="askConfirm('approve','<?= $p['id'] ?>','<?= addslashes($p['name']) ?>')">
...
<div id="detailModal" class="detail-modal">
    <div class="detail-content">
        ...
        <div class="detail-body">
            ...
            <div class="spec-grid">
                <div class="spec-box"><div class="spec-label">Material</div><div class="spec-value" id="modalMaterial"></div></div>
                <div class="spec-box"><div class="spec-label">Dimensi</div><div class="spec-value" id="modalDim"></div></div>
            ...
            <div class="detail-actions">
                ...
                <button class="btn-reject-lg" id="modalRejectBtn">
                    <i data-feather="x-circle"></i> Tolak & Notifikasi Seller
                </button>
            </div>
        </div>
    </div>
...
function openDetail(p) {
    ...
    document.getElementById('modalShop').textContent = p.shop;
    ...
    /* wire modal buttons */
    document.getElementById('modalApproveBtn').onclick = () => { closeDetail(); askConfirm('approve', p.id, p.name); };
    document.getElementById('modalRejectBtn').onclick  = () => { closeDetail(); askConfirm('reject',  p.id, p.name); };
...
function askConfirm(type, id, name) {
    ...
    if (type === 'approve') {
        ...
        document.getElementById('confirmTitle').textContent = 'Approve Produk?';
        document.getElementById('confirmDesc').textContent  = 'Produk ini akan dipublikasikan dan dapat ditemukan oleh semua pembeli di marketplace.';
        ...
        document.getElementById('confirmTitle').textContent = 'Tolak Produk?';
        document.getElementById('confirmDesc').textContent  = 'Produk ini akan ditolak dan seller akan menerima notifikasi beserta alasan penolakan.';
