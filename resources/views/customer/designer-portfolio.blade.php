                ...
                <div class="pt-10 border-t border-gray-100 space-y-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div class="bg-gray-50 p-6 rounded-2xl">
                            <p class="text-2xl font-bold text-primary">{{ $designer->consultations->where('status', 4)->count() }}</p>
                            <p class="text-[8px] font-black uppercase tracking-widest text-gray-400 mt-1">Completed Projects</p>
                        </div>
                        <div class="bg-gray-50 p-6 rounded-2xl">
                            <p class="text-2xl font-bold text-primary">4.9</p>
                            <p class="text-[8px] font-black uppercase tracking-widest text-gray-400 mt-1">Overall Rating</p>
                        </div>
                    </div>
