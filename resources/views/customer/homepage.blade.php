        ...
        <div class="content-container flex justify-between items-center py-4 px-6 mx-auto max-w-[1200px]">
            ...
            <div class="flex items-center space-x-6 flex-1 justify-end">
                @auth
                    ...
                    <a href="{{ route('notifications') }}" class="relative text-gray-400 hover:text-primary transition-colors">
                        <i class="fa-solid fa-bell text-lg"></i>
                        @if(Auth::user()->unreadNotifications->count() > 0)
                            <span class="absolute -top-1 -right-1 bg-red-500 text-white text-[8px] font-bold px-1 rounded-full border border-white">
