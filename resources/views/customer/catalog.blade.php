...
<form action="{{ route('customer.catalog') }}" method="GET" class="hidden lg:flex items-center bg-gray-50 border border-gray-100 rounded-md px-4 py-2 w-full max-w-[180px] group focus-within:bg-white focus-within:border-primary/30 transition-all">
    ...
    >
            ...
            <nav class="hidden md:flex items-center space-x-10 text-[13px] font-medium text-gray-500 tracking-wide">
                <a href="{{ route('customer.catalog') }}" class="text-primary font-bold">Collections</a>
            ...
            <div class="flex items-center space-x-6 flex-1 justify-end">
                @auth
                    <div class="flex items-center gap-3 mr-2 border-r pr-5 border-gray-100">
                        <div class="text-right hidden sm:block">
                            <p class="text-[9px] uppercase tracking-[0.2em] text-gray-400 font-bold leading-none mb-1">Welcome back</p>
                ...
                @else
                    ...
                    <a href="{{ route('role.selection') }}" class="bg-primary text-white px-5 py-2 rounded-sm text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/20 hover:bg-opacity-90 transition-all">Join Us</a>
                @endauth
            </div>
        </div>
    </header>
