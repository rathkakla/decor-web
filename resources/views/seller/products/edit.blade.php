...
<body class="text-gray-800">
    ...
    <aside id="sidebar" class="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full z-50 sidebar-transition">
        ...
        <nav class="flex-1 px-4 space-y-1">
            ...
            <a href="{{ route('seller.products.index') }}" class="flex items-center px-4 py-3 text-xs font-bold active-link transition-all rounded-lg">
        ...
        <div class="p-4 border-t border-gray-100">
            <a href="{{ route('seller.products.index') }}" class="flex items-center w-full px-4 py-3 text-xs font-bold text-gray-400 hover:bg-gray-50 transition-all rounded-lg">
                <i class="fa-solid fa-arrow-left mr-3 w-5 text-center"></i> Kembali
            </a>
        </div>
    </aside>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="price" required value="{{ old('price', $product->price) }}" class="w-full bg-gray-50 rounded-lg p-3 pl-10 text-sm border-transparent border-2">
                                </div>
                            </div>
