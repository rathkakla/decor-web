...
<body class="text-gray-800">
    ...
    <aside id="sidebar" class="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full z-50 sidebar-transition">
        ...
        <nav class="flex-1 px-4 space-y-1">
            <a href="{{ route('designer.dashboard') }}" class="flex items-center px-4 py-3 text-xs font-bold transition-all rounded-lg active-link">
    ...
    <main id="main-content" class="ml-64 flex flex-col min-h-screen sidebar-transition">
        ...
        <div class="p-10 space-y-10 flex-1">
            <div>
                <h2 class="text-3xl font-extrabold tracking-tight text-gray-800">Welcome back, Elena</h2>
                <p class="text-xs text-gray-400 mt-1 font-medium italic">Curating excellence for 12 ongoing projects.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm">
                    ...
                    <h3 class="text-3xl font-black mt-2">04</h3>
                </div>
                <div class="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm">
                    ...
                    <p class="text-[9px] font-black text-gray-400 uppercase tracking-widest">Monthly Earnings</p>
                    <h3 class="text-3xl font-black mt-2">$4,250</h3>
                </div>
                <div class="bg-white p-8 rounded-[32px] border border-gray-100 shadow-sm">
                    ...
                    <h3 class="text-3xl font-black mt-2">4.9<span class="text-xs text-gray-300">/5</span></h3>
                </div>
            </div>
            ...
            <!-- UPDATED: DETAILED TRANSACTION LOG WITH SEARCH -->
            <div class="bg-white p-10 rounded-[48px] border border-gray-100 shadow-sm">
                <div class="flex justify-between items-center mb-8">
                    <h3 class="text-[10px] font-black text-gray-800 uppercase tracking-widest">Detailed Transaction Log</h3>
                    <!-- Kiyowo Search Box -->
                    <div class="relative group">
                        ...
                        <input type="text" id="logSearch" placeholder="Search client or ID..." class="bg-gray-50 border-none rounded-2xl py-2.5 pl-10 pr-6 text-[10px] font-bold text-gray-900 focus:ring-2 focus:ring-primary/20 outline-none w-64 transition-all" onkeyup="filterTransactions()">
                    </div>
                </div>
                    ...
                    <table class="w-full text-left border-collapse" id="transactionTable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-[9px] font-black text-gray-400 uppercase tracking-widest pb-4">Project ID</th>
                                <th class="text-[9px] font-black text-gray-400 uppercase tracking-widest pb-4">Client Name</th>
                                <th class="text-[9px] font-black text-gray-400 uppercase tracking-widest pb-4">Category</th>
                                <th class="text-[9px] font-black text-gray-400 uppercase tracking-widest pb-4 text-right">Amount</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-50">
                            <tr class="group hover:bg-gray-50/50 transition-colors">
                                <td class="py-6 text-[10px] font-black text-gray-400 uppercase italic">Apr 28, 2026</td>
                                <td class="py-6 text-[10px] font-black text-primary uppercase tracking-tight">#DEC-88219</td>
                                <td class="py-6 text-[10px] font-black text-gray-800 uppercase tracking-widest">Elena Rodriguez</td>
                                <td class="py-6 text-[10px] font-black text-gray-800 uppercase tracking-widest">Residential</td>
                                <td class="py-6 text-[10px] font-black text-gray-800 italic text-right">$1,250.00</td>
                            </tr>
                            <tr class="group hover:bg-gray-50/50 transition-colors">
                                <td class="py-6 text-[10px] font-black text-gray-400 uppercase italic">Apr 25, 2026</td>
                                <td class="py-6 text-[10px] font-black text-primary uppercase tracking-tight">#DEC-88102</td>
                                <td class="py-6 text-[10px] font-black text-gray-800 uppercase tracking-widest">Marcus Thorne</td>
                                <td class="py-6 text-[10px] font-black text-gray-800 uppercase tracking-widest">Residential</td>
                                <td class="py-6 text-[10px] font-black text-gray-800 italic text-right">$2,400.00</td>
                            </tr>
                            <tr class="group hover:bg-gray-50/50 transition-colors">
                                <td class="py-6 text-[10px] font-black text-gray-400 uppercase italic">Apr 20, 2026</td>
                                <td class="py-6 text-[10px] font-black text-primary uppercase tracking-tight">#DEC-87944</td>
                                <td class="py-6 text-[10px] font-black text-gray-800 uppercase tracking-widest">Luminary Studios</td>
                                <td class="py-6 text-[10px] font-black text-gray-800 uppercase tracking-widest">Commercial</td>
                                <td class="py-6 text-[10px] font-black text-gray-800 italic text-right">$3,100.00</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [2100, 1800, 3200, 2900, 4250, 3800],
                    borderColor: '#B5733A',
